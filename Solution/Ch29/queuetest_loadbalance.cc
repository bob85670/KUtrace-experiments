...
//
// compile with g++ -O2 -pthread queuetest_loadbalance.cc dclab_log.cc dclab_rpc.cc kutrace_lib.cc -o queuetest_loadbalance
...
static const OneWork kSkewedWorkPattern[16][4] = {
  ...
  {{1, kMaxShortQUsec}, {4, kMaxLongQUsec}, {0, 0}, {0, 0}},
  {{2, kMaxShortQUsec}, {6, kMaxLongQUsec}, {0, 0}, {0, 0}},
  {{1, kMaxShortQUsec}, {5, kMaxLongQUsec}, {0, 0}, {0, 0}},
  {{3, kMaxShortQUsec}, {4, kMaxLongQUsec}, {6, kMaxLongQUsec}, {0, 0}},
