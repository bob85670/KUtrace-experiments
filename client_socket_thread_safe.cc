...
//
// compile with g++ -O2 -pthread client_socket_thread_safe.cc dclab_log.cc dclab_rpc.cc kutrace_lib.cc -o client_safe
//
...
bool ReceiveResponse(int sockfd, RPC* response) {
  if (!ReadOneRPC(sockfd, response, NULL)) {
